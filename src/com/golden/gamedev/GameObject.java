...
//        this.bsSound = this.parent.bsSound;
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.util.Utility#getRandom(int, int)
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseGraphics#getSize()
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseAudio#play(String)
	 * bsMusic.play(String)}.
     *
     * @see
     * com.golden.gamedev.engine.BaseAudio#setBaseRenderer(com.golden.gamedev.engine.BaseAudioRenderer)
...
//
//        amitsAudioPlayer.play(audiofile);
////        switch (audiofile) {
////            case "music/smb_kick.wav":
////                
////                break;
////        }
...
//    }
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseTimer#setFPS(int)
	 * bsTimer.setFPS(int)}.
     */
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseTimer#getCurrentFPS()
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseInput#getMouseX()
	 * bsInput.getMouseX()}.
     */
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseInput#getMouseY()
	 * bsInput.getMouseY()}.
     */
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseInput#isMousePressed(int)
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseInput#isKeyDown(int)
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseInput#isKeyPressed(int)
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseInput#setMouseVisible(boolean)
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseLoader#setMaskColor(Color)
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseLoader#getImage(String, boolean)
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseLoader#getImage(String)
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseLoader#getImages(String, int, int, boolean)
    ...
    /**
     * Effectively equivalent to the call null null     {@linkplain com.golden.gamedev.engine.BaseLoader#getImages(String, int, int)
